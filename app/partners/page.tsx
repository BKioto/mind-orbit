...
export default function PartnersPage() {
  return (
    <div className="min-h-screen bg-slate-950 pt-24 pb-10 px-4 sm:px-8 relative overflow-hidden font-sans" dir="rtl">
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-12">
            ...
            <p className="text-slate-400 max-w-2xl leading-8 text-lg">
                مایند اوربیت (MindOrbit) بخشی از یک اکوسیستم بزرگتر است. در این بخش، مجموعه‌ای از پروژه‌های منتخب و کسب‌وکارهای معتبری که از زیرساخت‌های فنی یا هوش مصنوعی ما استفاده می‌کنند را معرفی می‌کنیم.
            </p>
        </div>
