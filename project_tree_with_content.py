...
# ==========================================
# تنظیمات اصلی پروژه Mind Orbit
# ==========================================
PROJECT_NAME = "mind-orbit"
ROOT_PATH = r"C:\projects\mind-orbit"
...
EXCLUDE_FILES = {
    ...
    "pnpm-lock.yaml",
    "icon.png",
    "project_tree_with_content.py",  # خود اسکریپت
    os.path.basename(OUTPUT_FILE),   # فایل خروجی
    "run_snapshot.bat",
}
